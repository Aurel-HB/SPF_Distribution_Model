...
####### prepare the data #######
source("C:/Users/ahebertb/Desktop/StageAurel/code/script/process_data.R")
#take the data not tranformed and prepare same format for each data

####### load the data #######
source("C:/Users/ahebertb/Desktop/StageAurel/code/script/load_data.R")
...
source("C:/Users/ahebertb/Desktop/StageAurel/code/script/cpue_grid_plot.R")
...
source("C:/Users/ahebertb/Desktop/StageAurel/code/script/table_per_year.R")
# this split the big table in smaller table but not necesary for the work

####### data plot #######
source("C:/Users/ahebertb/Desktop/StageAurel/code/script/data_grid_plot.R")
...
source("C:/Users/ahebertb/Desktop/StageAurel/code/script/analyse_cpue.R")
####### Research of correlation and filter on the cpue #######
source("C:/Users/ahebertb/Desktop/StageAurel/code/script/correlation_cpue_biomass.R")
source("C:/Users/ahebertb/Desktop/StageAurel/code/script/PS_PTM_biomass_correlation.R")
...
#(voir avec Matthieu Authier car c'est lui qui s'en ai chargé.
#je n'ai pas le code associé juste le tableau final pour la sardine)
