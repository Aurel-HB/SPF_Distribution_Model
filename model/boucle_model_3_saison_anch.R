for (annee in as.numeric(periode)){
  data_model_fin <- readRDS(paste(local_path,"code/data_model/anch_tot.rds", sep = ""))
  ...
  saveRDS(res.jo, file = paste(local_path,"/code/output/result/result_summer_null_",annee,"_894",".rds", sep = ""))
  saveRDS(summary(res.jo), file = paste(local_path,"/code/output/summary/summer_summary_null_",annee,"_894",".rds", sep = ""))
