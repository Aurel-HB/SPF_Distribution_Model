...
for (annee in as.numeric(periode)){
  ...
  saveRDS(res.jo, file = paste(local_path,"/code/output/result/result_saison_dist_",annee,"_894",".rds", sep = ""))
  saveRDS(summary(res.jo), file = paste(local_path,"/code/output/summary/summary_dist_",annee,"_894",".rds", sep = ""))
  ...
  ggsave2(plot = plot_tot, paste(path.output,"pred/","binom_dist_",annee,".png", sep = ""), width = 8.50, height = 6.50 )
  plot.binom <- list(c(plot.binom, list(p1, p2)))
  ...
  plot_tot <- plot_grid(p1, p2)
  ggsave2(plot = plot_tot, paste(path.output,"pred/","lognorm_dist_",annee,".png", sep = ""), width = 8.50, height = 6.50 )
  plot.logn <- list(c(plot.logn, list(p1, p2)))
  ...
  plot_tot <- plot_grid(p1, p2)
  ggsave2(plot = plot_tot, paste(path.output,"pred/","ppp_dist_",annee,".png", sep = ""), width = 8.50, height = 6.50 )
  plot.ppp <- c(plot.ppp, list(p1, p2))
  
}

plot_grid(plot.binom[1][[1]], plot.binom[3][[1]], plot.binom[5][[1]], plot.binom[7][[1]], plot.binom[9][[1]],
          plot.binom[11][[1]], plot.binom[13][[1]], plot.binom[15][[1]], plot.binom[17][[1]], plot.binom[19][[1]],
          plot.binom[21][[1]], plot.binom[23][[1]], plot.binom[25][[1]], plot.binom[27][[1]],nrow = 3, ncol = 5)

plot_grid(plot.logn[1][[1]], plot.logn[3][[1]], plot.logn[5][[1]], plot.logn[7][[1]], plot.logn[9][[1]],
          plot.logn[11][[1]], plot.logn[13][[1]], plot.logn[15][[1]], plot.logn[17][[1]], plot.logn[19][[1]],
          plot.logn[21][[1]], plot.logn[23][[1]], plot.logn[25][[1]], plot.logn[27][[1]],nrow = 3, ncol = 5)

plot_grid(plot.ppp[1][[1]], plot.ppp[3][[1]], plot.ppp[5][[1]], plot.ppp[7][[1]], plot.ppp[9][[1]],
          plot.ppp[11][[1]], plot.ppp[13][[1]], plot.ppp[15][[1]], plot.ppp[17][[1]], plot.ppp[19][[1]],
          plot.ppp[21][[1]], plot.ppp[23][[1]], plot.ppp[25][[1]], plot.ppp[27][[1]], nrow = 3, ncol = 5)
