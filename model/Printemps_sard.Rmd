...
saveRDS(res.jo, file = paste(local_path,"/code/model/result_sard_spring_894",".rds", sep = ""))
res.jo <- readRDS(paste(local_path,"/code/model/result_sard_spring_894",".rds", sep = ""))
